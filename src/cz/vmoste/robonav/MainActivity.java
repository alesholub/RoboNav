...
Changelog:
V1.9.5.?? 2017-??-?? 
V1.9.5.?? 2017-??-?? A* algorithm for path planning (according to map)
V1.9.5.?? 2017-??-?? optimized user interface (buttons, HUD)
V1.9.5.?? 2017-??-?? extra layer for user interface (or extra Mat and mask for buttons)
...
V1.9.7.00 2017-11-26 simplified log and screen layout, preparations for Robotour Marathon   
...
V1.9.5.07 2017-05-26 trust to azimuth from BT device instead of internal compassAzimuth 
V1.9.5.06 2017-05-24 finding the highest blob (instead of the largest) 
V1.9.5.05 2017-05-23 support for up to 99 variants of paths and goals (different files) 
V1.9.5.04 2017-05-22 in mode 2 (Roboorienteering) set color blob radius by plus and minus buttons 
V1.9.5.03 2017-05-21 in mode 2 (Roboorienteering) process color blob only (and wider color blob radius) 
V1.9.5.02 2017-05-20 proper saving of limit1 
V1.9.5.01 2017-05-11 sending command "n" (new azimuth) at manual compass calibration 
V1.9.5 2017-05-08 parameters tuning, better modes sorting and displaying, version for Robotem Rovne 2017
V1.9.4.11 2017-05-07 driving signal influenced by azimDiff for Robotem Rovne
V1.9.4.10 2017-05-05 better compass adjust, camera angle stabilization
V1.9.4.09 2017-05-04 compass adjust (according to desired heading)
V1.9.4.08 2017-05-03 RR mode with less compass intervention
V1.9.4.07 2017-05-02 basic version for Robotem Rovne 2017 (RoadDetector only, simple logic)
V1.9.4.06 2017-04-23 ColorBlobDetectr used for target detection only
V1.9.4.05 2017-04-22 RoadDetector as simple as possible (to by as fast as possible) 
V1.9.4.04 2017-04-21 one frame for ObstacleDetector (contours, free directions, avoiding direction, stop needed) 
V1.9.4.03 2017-04-20 one frame for ColorBlobDetector (target position/center and size/width/height)
V1.9.4.02 2017-04-19 one frame for RoadDetector (contours, safe directions, top direction, top height, best free direction) 
V1.9.4.01 2017-04-18 refactoring LineDetector to ObstacleDetector
...
public class MainActivity extends Activity {
    ...
    private int mSearchMode = 3;
    private int mVoiceOutput = 0;
    private int mThresholdLimit = 135;
    private int mMinArea = 50;
    private String mHSV1 = "75,150,150,0";
    private String mHSV2 = "10,255,220,0";
    private String address = "00:00:00:00:00:00";
    private String address1 = "00:00:00:00:00:00";
    private String address2 = "00:00:00:00:00:00";
    private String btBonded = "";
    private String btAllowed = "";
    ...
    private static final String VOICE_OUTPUT_KEY = "voice_output";
    private static final String THRESHOLDLIMIT_KEY = "thresholdlimit";
    private static final String MINAREA_KEY = "minarea";
    private static final String HSV1_KEY = "hsv1";
    private static final String HSV2_KEY = "hsv2";
    private static final String BTDEVICE_KEY = "btdevice";
	...
	private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothAdapter.ACTION_DISCOVERY_STARTED.equals(action)) {
    	    	...
    	    	Toast.makeText(getApplicationContext(), "Discovering BT devices "+btAllowed, Toast.LENGTH_SHORT).show();
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), getString(R.string.app_name)+" "
                +getString(R.string.app_version)+" "+getString(R.string.app_date), Toast.LENGTH_LONG).show();

	    if ( (mBluetoothAdapter != null)  && (mBluetoothAdapter.isEnabled()) ) {
	    	// discovery and autoconnect
	    	if (mBluetoothAdapter.isDiscovering()) {
	    		mBluetoothAdapter.cancelDiscovery();
	    	}
    	...
    	NavigationActivity.setHSV1(mHSV1);
    	NavigationActivity.setHSV2(mHSV2);
    	NavigationActivity.setVoiceOutput(mVoiceOutput);
    	NavigationActivity.setOrientation(mScreenOrientation);
    	NavigationActivity.setAddress(address1);
    	NavigationActivity.setAddress2(address2);
	...
	public void onStart() {
        ...
        //Toast.makeText(getApplicationContext(), "searchMode: "+mSearchMode, Toast.LENGTH_LONG).show();
...
//                alert.show();
    ...
    private void readPrefs() {
		...
		mSearchMode = readIntPref(SEARCHMODE_KEY, mSearchMode, 9);
		mVoiceOutput = readIntPref(VOICE_OUTPUT_KEY, mVoiceOutput, 1);
		mThresholdLimit = readIntPref(THRESHOLDLIMIT_KEY, mThresholdLimit, 255);
		mMinArea = readIntPref(MINAREA_KEY, mMinArea, 9999);
		mHSV1 = readStringPref(HSV1_KEY, mHSV1);
		mHSV2 = readStringPref(HSV2_KEY, mHSV2);
		address1 = readStringPref(BTDEVICE_KEY, address);
		//if (address1.length()<1) address1 = "00:00:00:00:00:00";
		address2 = readStringPref("btdevice2", address2);
		//if (address2.length()<1) address2 = "00:00:00:00:00:00";
   }
...
*/                
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_CONNECT_DEVICE:
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(getApplicationContext(), "Autoconnect1 to: "
        ...
        case REQUEST_ENABLE_BT:
            ...
            if (resultCode != Activity.RESULT_OK) {
                ...
                // autoconnect
                Toast.makeText(getApplicationContext(), "Autoconnect2 to: "
                        +address, Toast.LENGTH_LONG).show();
                // Get the BLuetoothDevice object
                BluetoothDevice device = mBluetoothAdapter.getRemoteDevice(address);
                // Attempt to connect to the device
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==R.id.connect) {
        	...
        	doPreferences();
            return true;
        } else if (item.getItemId()==R.id.menu_special_keys) {
            doDocumentKeys();
            return true;
    	} else if (item.getItemId()==R.id.menu_start_stop_save) {
    ...
    private void doPreferences() {
    	...
    	Intent prefIntent = new Intent(this, TermPreferences.class);
	...
	private void showAboutDialog() {
		mAboutDialog = new Dialog(MainActivity.this);
...
*/
    ...
    private void update() {
        ...
        try {
            ...
            //Core.putText(NavigationActivity.mRgba, "s:"+stringRead, new org.opencv.core.Point(10,50), 2, 2.0, new Scalar(250,250,150), 2);
            NavigationActivity.setToRgba(stringRead);
        } catch (InterruptedException e) {
        }
    }
    ...
    public boolean writeLog(String buffer) {
    	...
    	SimpleDateFormat format = new SimpleDateFormat("yyMMdd HHmmss",Locale.US);
    	String currentDateTimeString = format.format(new Date());
	    ...
	    if (Environment.MEDIA_MOUNTED.equals(state)) {
	    	...
	    	try {
	            ...
	            int mNewline = buffer.indexOf("\r");
	            if (mNewline>0) {
	            	buffer = buffer.substring(0, mNewline)+" "+currentDateTimeString+buffer.substring(mNewline);
	            } else if (mNewline==0) {
	            	buffer = " "+currentDateTimeString+buffer;
	            }
	            pw.print( buffer );
	            pw.flush();
	            pw.close();
